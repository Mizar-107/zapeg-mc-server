...
$extraMods = @(
    ...
    [pscustomobject]@{ Name = 'Effortless Building'; Prefix = 'effortlessbuilding-1.20.1-'; FileName = 'effortlessbuilding-1.20.1-3.11.jar'; FileId = '7944965'; Pin = 'CurseForge file 7944965' }
)
