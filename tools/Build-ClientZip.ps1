...
$ownedMods = @(
    ...
    [pscustomobject]@{
        ...
        FileName = 'zapeg-runtime-forge-1.20.1-0.3.0.jar'
        RelativePath = 'overrides\mods\zapeg-runtime-forge-1.20.1-0.3.0.jar'
    ...
    $installLines = if ($Mode -eq 'patch') {
        @(
            ...
            '',
             ...
             '7. Bu üç mod ailesi için yalnız cc-tweaked-1.20.1-forge-1.116.1.jar, zapeg-citizens-forge-1.20.1-0.4.0.jar ve zapeg-runtime-forge-1.20.1-0.3.0.jar bulunmalı; diğer ATM9/ZapeG modlarını silme. mods\iceandfire-...jar, üç resmi IV jarı ve alekiNiftyShips-FORGE-1.20.1-1.0.14.jar doğrudan görünmeli.',
        ...
        @(
            ...
            '',
             ...
             '5. Bu üç mod ailesi için yalnız cc-tweaked-1.20.1-forge-1.116.1.jar, zapeg-citizens-forge-1.20.1-0.4.0.jar ve zapeg-runtime-forge-1.20.1-0.3.0.jar bulunmalı; diğer ATM9/ZapeG modlarını silme. mods\iceandfire-...jar, üç resmi IV jarı ve alekiNiftyShips-FORGE-1.20.1-1.0.14.jar doğrudan görünmeli; iç içe ZapeG klasörü olmamalı.',
