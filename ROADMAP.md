...
- **Nifty Ships evaluated, not added:** core 1.0.14 fits Forge 47.4.10 and has no duplicate material economy, but unresolved upstream chunk-reload/mooring, drift, anchor and rendering defects fail the compatibility gate. The official BOP addon also crashes against ATM9's BOP 19.0.0.96 API. Keep Eureka/VS as the supported ship system; reconsider Nifty only after a fixed build or an explicit disposable-world multiplayer pass.
