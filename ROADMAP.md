...
- The generated player patch grows from 15 to **22** exact client additions. Numen is pinned to CurseForge file `8551640`, CC:Tweaked 1.116.1 is re-pinned from Modrinth, the owned Citizens jar is tracked by SHA-256, and every vehicle jar is exact-pinned and hash-locked.
